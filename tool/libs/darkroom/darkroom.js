...
function() {
    ...
    Darkroom.UI = {
        ...
        createButton: function(options) {
            ...
            buttonElement.type = "button", buttonElement.className = "darkroom-button darkroom-button-" + options.type, buttonElement.innerHTML = options.image , this.element.appendChild(buttonElement);
    ...
    Darkroom.plugins.history = Darkroom.Plugin.extend({
        ...
        _initButtons: function() {
            ...
            return this.backButton = buttonGroup.createButton({
                image: "<i class='fa fa-step-backward'></i>",
                disabled: !0
            }), this.forwardButton = buttonGroup.createButton({
                image: "<i class='fa fa-step-forward'></i>",
                disabled: !0
        ...
        initialize: function() {
            var buttonGroup = this.darkroom.toolbar.createButtonGroup(),
                leftButton = buttonGroup.createButton({
                    image: "<i class='fa fa-undo'></i>"
                }),
                rightButton = buttonGroup.createButton({
                    image: "<i class='fa fa-repeat'></i>"
                });
    ...
    Darkroom.plugins.crop = Darkroom.Plugin.extend({
        ...
        initialize: function() {
            ...
            this.cropButton = buttonGroup.createButton({
                image: "<i class='fa fa-crop'></i>"
            }), this.okButton = buttonGroup.createButton({
                image: "<i class='fa fa-check'></i>",
                type: "success",
                hide: !0
            }), this.cancelButton = buttonGroup.createButton({
                image: "<i class='fa fa-close'></i>",
                type: "danger",
                hide: !0
